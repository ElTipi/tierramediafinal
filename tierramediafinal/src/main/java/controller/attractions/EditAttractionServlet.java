...
public class EditAttractionServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Attraction attraction = attractionService.update(id, name, cost, duration, capacity, tipo_atraccion, description);

		if (attraction.isValid()) {
			resp.sendRedirect("/tierramediafinal/attractions/index.do");
		} else {
			req.setAttribute("attraction", attraction);
