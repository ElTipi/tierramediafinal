...
public class AttractionDAOImpl implements AttractionDAO {
	...
	public int insert(Attraction attraction) {
		try {
			String sql = "INSERT INTO ATTRACTIONS (NAME, COST, DURATION, CAPACITY, TIPO_ATRACCION, DESCRIPTION) VALUES (?, ?, ?, ?, ?, ?)";
			Connection conn = ConnectionProvider.getConnection();
			...
			statement.setString(i++, attraction.getTipo_atraccion());
	...
	public int update(Attraction attraction) {
		try {
			String sql = "UPDATE ATTRACTIONS SET NAME = ?, COST = ?, DURATION = ?, CAPACITY = ?, TIPO_ATRACCION = ?, DESCRIPTION = ? WHERE ID = ?";
			Connection conn = ConnectionProvider.getConnection();
